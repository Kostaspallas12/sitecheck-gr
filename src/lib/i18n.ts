...
export const translations: Record<Lang, T> = {
  en: {
    ...
    features: [
      { icon: "🔒", title: "Security", desc: "CSP, HSTS, X-Frame-Options and other critical headers" },
      ...
      { icon: "👁️", title: "Accessibility", desc: "Can all users navigate your frontend? Contrast, keyboard, screen readers" },
  ...
  el: {
    ...
    features: [
      { icon: "🔒", title: "Security", desc: "CSP, HSTS, X-Frame-Options και άλλα critical headers" },
      { icon: "⚡", title: "Απόδοση", desc: "Core Web Vitals, LCP, CLS, speed score" },
      { icon: "🔍", title: "SEO", desc: "Meta tags, canonicals, robots.txt, structured data" },
      { icon: "👁️", title: "Accessibility", desc: "Μπορούν όλοι να χρησιμοποιήσουν το frontend σου; Contrast, keyboard, screen readers" },
